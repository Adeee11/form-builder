...
const Results = ({ formId }: propType) => {
  ...
  return (
    <Wrapper>
      <Menu>
        <Nav menu={menu} setMenu={setMenu} data={data} />
      </Menu>
      {menu === "insights" && <InsightsComponent data={data} />}
      {menu === "summary" && (
        <Summary>
          <div className="first">
          ...
          <div className="second">
            ...
            <div className="text">
              Share your results with anyone. Your report automatically updates
              as new answers come in.
            </div>
          </div>
        </Summary>
      )}
      ...
      {menu === "responses" && (
        <Responses>
          ...
          <div className="con">
            ...
            {data &&
              data.form.submission.map((i: any, id: number) => (
                <div
                  key={i.id}
                  onClick={() => saveSubmission(i.res, i.date, i.id)}
                >
                  <div className="flex">
                    <div className="block">{i.date}</div>
